...
if(isset($_POST) && !empty($_POST['login']) && !empty($_POST['pass'])){
    ...
    $sql = "SELECT user_client.id, user_client.nom, user_client.prenom, user_client.fonction, user_client.id_client
    FROM user_client WHERE (((user_client.loggin)='".$login."') AND ((user_client.password)='".$pass."'))";
